...
const BEHAVIOR_KEYS = new Set(["reaction_level", "link_preview", "block_reply", "render_mode", "topic_session_mode", "quote_user_message", "quote_user_message_in_group", "quote_user_message_in_dm"]);
