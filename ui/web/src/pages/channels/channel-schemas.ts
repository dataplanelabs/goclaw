...
export const configSchema: Record<string, FieldDef[]> = {
  ...
  zalo_personal: [
    ...
    { key: "enable_native_styles", label: "Native text styles", type: "boolean", defaultValue: true, help: "Render LLM markdown (bold/italic/strike/underline/lists) as native Zalo styled spans via textProperties. Off = full markdown strip (legacy v3.21.10 behavior)." },
