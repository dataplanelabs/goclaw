...
export const configSchema: Record<string, FieldDef[]> = {
  telegram: [
    ...
    { key: "rich_message", label: "Rich Message", type: "boolean", defaultValue: true, help: "Send replies as Bot API 10.1 rich markdown — headings, tables, code & math render natively (falls back to HTML on older clients)" },
