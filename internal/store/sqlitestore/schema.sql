...
CREATE TABLE IF NOT EXISTS cron_jobs (
    ...
    inject_target_history_limit INTEGER NOT NULL DEFAULT 100,
    next_run_at      TEXT,
    last_run_at      TEXT,
...
-- ============================================================
-- usage_events + usage_event_rollups (mirrors PG migration 000081)
-- Append-only per-tool-call / per-skill-activation analytics. Recorded
-- best-effort from the agent tool pipeline; rolled up hourly by SnapshotWorker.
-- Intentionally excludes user IDs, raw prompts, tool args, and outputs.
-- ============================================================
...
-- skill self-evolution control plane (mirrors PG migration 000082)
...
CREATE TABLE IF NOT EXISTS skill_usage_metrics (
    ...
    trace_id          TEXT,
    invocation_id     TEXT,
    invocation_source TEXT NOT NULL DEFAULT 'runtime',
...
CREATE TABLE IF NOT EXISTS skill_improvement_suggestions (
    ...
    reviewed_by_actor_type TEXT NOT NULL DEFAULT '',
